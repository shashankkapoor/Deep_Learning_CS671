...
predict=predict.reshape(xx1.shape)
plt.contourf(xx1, xx2, predict, alpha=0.3, cmap=cmap)
plt.scatter(train_nls_c1[:, 0], train_nls_c1[:, 1], color='magenta' ,label='Class 1', edgecolors='black')
plt.scatter(train_nls_c2[:, 0], train_nls_c2[:, 1], color='orange',label='Class 2', edgecolors='black')
plt.legend()
plt.title('Decision region between class1-class2')
plt.show()
...
plt.contourf(xx1, xx2, predict, alpha=0.3, cmap=cmap)
plt.scatter(train_nls_c1[:, 0], train_nls_c1[:, 1], color='magenta' ,label='Class 1', edgecolors='black')
plt.scatter(train_nls_c3[:, 0], train_nls_c3[:, 1], color='green',label='Class 3', edgecolors='black')
plt.legend()
plt.title('Decision region between class1-class3')
plt.show()
...
X=np.delete(np.vstack([train_nls_c1,train_nls_c2,train_nls_c3]),2,axis=1)
y = np.concatenate((np.zeros(len(train_nls_c1)),np.ones(len(train_nls_c2)), np.ones(len(train_nls_c3)) * 2))
weights_1=weights_nls_c1_c2
weights_2=weights_nls_c1_c3
